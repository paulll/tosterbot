Дисклеймер: данная программа, возможно, представляет из себя просто огромную свалку велосипедов и костылей, но я на это срал, т.к. и так сойдет.
...
**** Коэффициент доверия на текущий момент (текущей сессии)
= коэффициент для текущего собеседника * на коэффициент подтвержденности личности. 

**** Коэффициент доверия к определенному собеседнику (источника информации)
